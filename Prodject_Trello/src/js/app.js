...
const date = new Date();
const actualDate = `${date.getDate().toString().padStart(2, '0')}.${(date.getMonth() + 1).toString().padStart(2, '0')}.${date.getFullYear()}`;const wrapperCardElement = document.querySelector(".wrapper-card");
